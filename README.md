<h1 align="center">Awesome Writing Tools 💕 <a href="https://github.com/sindresorhus/awesome"><img alt="Awesome" src="https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg" /></a></h1>
...
- **[StoryCAD](https://storybuilder.org):** A free, open-source story outlining tool for Windows and macOS. Structures story development across character, problem, plot, setting, and theme using dedicated forms and AI-assisted critique. Published on the Microsoft Store and Mac App Store.
- **[StoryCAD API](https://api.storybuilder.org):** REST API for programmatic access to StoryCAD's story analysis and outlining features, developed by the StoryBuilder Foundation (501(c)(3) nonprofit). Available as [`storycadlib`](https://pypi.org/project/StoryCADLib/) on PyPI.
