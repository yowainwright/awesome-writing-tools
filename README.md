...
- **[Mangaplay Studio](https://mangaplay.studio/):** A manga, comic and screenplay editor that uses a plain-text script format with visual panel layout and storyboard preview. Available as a web app and [Chrome extension](https://chromewebstore.google.com/detail/hiidpbendbgfcdidhccnldbkgdeikibi).
